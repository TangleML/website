...
:::warning
Make sure you understand how [pipelines are persisted](/docs/getting-started/pipelines-persistence). Unless a pipeline is submitted as a run, it is stored in the browser's storage.
:::
