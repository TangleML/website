...
TangleML Studio provides a comprehensive web-based interface for building, managing, and running machine learning pipelines. This guide walks you through the main areas of the application: Home screen, Editor, Pipeline Run, and Settings.
...
The **All Runs** section displays a comprehensive list of all pipeline runs on your TangleML instance.
...
The **My Pipelines** section manages your draft pipelines stored locally in browser storage.
...
- Click **Add tag** to create a new tag. Tags appear in the pipeline list on the Home screen.
